...
class Metric():
    ...
    def score(self, name):
        ...
        elif name == "prob_formats_4":
            return self.prob_formats_4()
        elif name == "prob_formats_5":
            return self.prob_formats_5()
        elif name == "intervention_formats_2":
            return self.intervention_formats_2()
        else:
            return -1

    def prob_formats_4(self):
        f = open(os.path.join(self.output_dir, "prob_formats_4.txt"),'w')
    ...
    def prob_formats_5(self):
        f = open(os.path.join(self.output_dir, "prob_formats_5.txt"),'w')
    ...
    def intervention_score(self, output_file = "interventions.txt"):
        ...
        for i in tqdm(range(len(self.DataSet))):
            ...
            for i in range(3):
                score = calc_prob(sentence[i+1], ans_pair)
                if sentiment == -1:
                    xx = score[0]
                    score[0] = score[1] 
                    score[1] = xx
